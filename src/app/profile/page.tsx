...
import { Company, useCompanyHandlers, useMe, User, useUserHandlers } from '@edifitech-graphql/index';
...
export default function ProfilePage() {
    ...
    const handleChangePassword = async () => {
        ...
        handlePassword(user, newPassword, currentPassword, {
            onSuccess() {
                setCurrentPassword('');
                setNewPassword('');
                setConfirmPassword('');
